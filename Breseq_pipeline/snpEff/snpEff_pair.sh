...
#create diff file for some nice downstream analysis
#python $pipeline_installation/Breseq_pipeline/snpEff/diff_for_downstream.py "$outbase"
#run snpEff
...
#downstream analysis
#run snpEff for downstream analysis file
#java -Xmx4g -jar ${SNPEFF_PATH}/snpEff.jar -noStats -no-downstream -no-upstream $genome "${outbase}downstream_analysis_diff.vcf" > "${comparison}/results/downstream_analysis_snpEff.vcf"
#python /home/users/yair/Documents/PhD_projects/project_B/bin/gene_loss_pipeline/analysis/analyze_snpEff_output.py "${comparison}/results/downstream_analysis_snpEff.vcf"
#python /home/users/yair/Documents/PhD_projects/project_B/bin/gene_loss_pipeline/analysis/dn_ds/dn_ds.py "${comparison}/results/downstream_analysis_snpEff.vcf.aa.txt" "${comparison}/results/downstream_analysis_snpEff.vcf.dnds.txt"
